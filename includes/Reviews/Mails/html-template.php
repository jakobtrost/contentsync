 ...
 *
 * This template file outputs the HTML structure for review notification emails.
 * It expects the following variables to be set before including:
 *
 * @var string $title  The email title/heading.
 * @var string $body   The main email body content.
				...
				<div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 580px; padding: 24px;">
					...
					<div class="title" style="clear: both; margin-top: 10px; text-align: center; width: 100%;">
						<table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
							<tr>
								<td class="content-block" style="font-family: DM Sans, Inter, Helvetica, -apple-system, BlinkMacSystemFont, Roboto, Arial, sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #1E1E1E; font-size: 32px; text-align: center;" valign="top" align="center">
									<h1 style="font-family: DM Sans, Inter, Helvetica, -apple-system, BlinkMacSystemFont, Roboto, Arial, sans-serif; color: #1E1E1E; font-size: 32px; text-align: center;"><?php echo esc_html( $title ); ?></h1>
								</td>
							</tr>
						</table>
					</div>
					...
					<table role="presentation" class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background: #ffffff; border-radius: 3px; color: #1E1E1E; width: 100%;" width="100%">
						...
						<tr>
							...
							<table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
								<tr>
								<td style="font-family: DM Sans, Inter, Helvetica, -apple-system, BlinkMacSystemFont, Roboto, Arial, sans-serif; font-size: 16px; color: #1E1E1E; vertical-align: top;" valign="top"><?php echo wp_kses_post( $body ); ?></td>
								</tr>
							</table>
							</td>
						</tr>
					...
					<div class="footer" style="clear: both; margin-top: 10px; text-align: center; width: 100%;">
						<table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
							<tr>
								<td class="content-block powered-by" style="font-family: DM Sans, Inter, Helvetica, -apple-system, BlinkMacSystemFont, Roboto, Arial, sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #999999; font-size: 12px; text-align: center;" valign="top" align="center"><?php echo wp_kses_post( $footer ); ?></td>
							</tr>
						</table>
					</div>
					<!-- END FOOTER -->
