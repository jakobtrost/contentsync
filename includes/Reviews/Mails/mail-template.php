 ...
 *
 * This file contains the HTML template structure for review notification emails.
 * The template is responsive and includes inline styles for email client compatibility.
 *
