 ...
 *
 * Provides static methods for retrieving regex patterns used to find
 * and replace nested posts, strings, and terms in post content.
 */
class Nested_Content_Patterns {
	 ...
	 *                              the ID. Default: 2
	 */
	public static function get_post_patterns( $post_id = 0, $post = null ) {
	 ...
	 */
	public static function get_string_patterns( $subject, $post_id ) {
		...
		} elseif ( strpos( $upload_url, 'https://' ) === 0 && strpos( $site_url, 'https://' ) !== 0 ) {
	 ...
	 */
	public static function get_term_patterns( $post_id, $post ) {
