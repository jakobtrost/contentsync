...
use Contentsync\Translations\Translation_Tool_Factory;
use Contentsync\Translations\Translation_Tool_Base;
...
class Translation_Manager {
	...
	public static function set_translations_from_import( $post_id, $language_data, $imported_post_map ) {
		...
		Logger::add( 'Set translations for the post:', $language );
