...
use Contentsync\Translation_Tools\Translation_Tool_Factory;
use Contentsync\Translation_Tools\Translation_Tool_Base;
use Contentsync\Translation_Tools\Translation_Tool_Polylang;
use Contentsync\Translation_Tools\Translation_Tool_WPML;
...
class Translation_Manager {
	...
	public static function get_translation_tool() {
		return Translation_Tool_Factory::get_tool_name();
	}
	...
	public static function reset_translation_tool() {
		...
		Translation_Tool_Factory::reset();
	}
	...
	public static function unload_translation_tool_hooks() {
		return Translation_Tool_Factory::unload_inactive_tool_hooks();
	}
	...
	public static function reload_translation_tool_hooks() {
		return Translation_Tool_Factory::reload_active_tool_hooks();
	}
