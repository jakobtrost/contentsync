 ...
 *
 * This class provides methods for interacting with remote networks and
 * sites connected to the Content Sync system. It provides methods
 ...
 * Remote Request
 *
 * Provides static methods for interacting with remote Content Sync API endpoints.
 */
class Remote_Request {
	 ...
	 * @return bool
	 */
	public static function check_connection_authentication( $connection_or_site_url ) {
	 ...
	 * @return mixed
	 */
	public static function get_remote_synced_posts( $connection_or_site_url, $query_args = null ) {
	 ...
	 * @return mixed
	 */
	public static function get_remote_synced_post( $connection_or_site_url, $gid ) {
		return self::send_request(
			$connection_or_site_url,
			'posts/' . self::prepare_gid_for_url( $gid )
		);
	}
	 ...
	 * @return mixed
	 */
	public static function prepare_remote_synced_post( $connection_or_site_url, $gid ) {
		return self::send_request(
			$connection_or_site_url,
			'posts/' . self::prepare_gid_for_url( $gid ) . '/prepare'
		);
	}
