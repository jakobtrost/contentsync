<?php
/**
 * Content condition service helper class.
 *
 ...
 * methods allow you to retrieve conditions by ID, list all
...
/**
 * Content Condition Service
 */
final class Content_Condition_Service {
	 ...
	 */
	public static function get_cluster_content_condition_by_id( $content_condition_id ) {
	 ...
	 * @return Content_Condition[]|false
	 */
	public static function get_cluster_content_conditions() {
		global $wpdb;
	 ...
	 * @return Content_Condition[]|false
	 */
	public static function get_cluster_content_conditions_by_cluster_id( $cluster_id ) {
		global $wpdb;
	...
	/**
	 * Insert a new content condition
	 *
	 * @param array $content_condition
	 *
	 * @return int|false
	 */
	public static function insert_cluster_content_condition( $content_condition ) {
		global $wpdb;
	 ...
	 *
	 * @param Content_Condition|array $content_condition
	 *
	 * @return int|false
	 */
	public static function update_cluster_content_condition( $content_condition ) {
		global $wpdb;
	 ...
	 * @return int|false
	 */
	public static function delete_cluster_content_condition( $content_condition_id ) {
		global $wpdb;
	 ...
	 */
	public static function get_posts_by_cluster_content_condition( $condition ) {
		...
		$query_args = self::get_query_args_for_cluster_content_condition( $condition );
	 ...
	 * @return array|false
	 */
	public static function get_query_args_for_cluster_content_condition( $condition ) {
	 ...
	 * @return Content_Condition[]|false
	 */
	public static function get_cluster_content_conditions_including_posttype( $post_type ) {
	...
	public static function get_cluster_content_conditions_including_post( $post, $with_filter = null ) {
		...
		foreach ( $conditions_that_match_blog_and_posttype as $condition ) {
			...
			if ( self::post_meets_cluster_content_condition( $post, $condition ) ) {
